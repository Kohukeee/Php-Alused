...
<html lang="en">
  ...
  <body>
    <!-- menüü -->
     <!-- mb-4, margin bottom 4 tähendab, et menüü ja kastide vahele jääb rohkem tühja ruumi -->
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" href="index.php" href="#">Home</a>
        </li>
        <li class="nav-item">
      ...
      <form class="d-flex" role="seatch" method="get" action="index.php">
